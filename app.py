...
LANG = {
    "ko": {
        ...
        "privacy_4": "오행",
        "important": "유의사항",
        "important_body": "입력된 정보는 저장되지 않으며, 사주 풀이를 위해 일시적으로 처리됩니다.",
        "lang_select": "언어 선택",
        "lang_ko": "한국어",
        "lang_en": "English",
        "input_section": "입력 정보",
    ...
    "en": {
        ...
        "important_body": "Your information is not stored and is used only temporarily to generate your saju reading.",
